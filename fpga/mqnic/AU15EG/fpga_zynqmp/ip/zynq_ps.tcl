...
set_property -dict [list \
   CONFIG.PSU_VALUE_SILVERSION {3}  \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0###GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#USB0 Reset#GPIO1 MIO#I2C 0#I2C 0#GPIO1 MIO#GPIO1 MIO#CAN 0#CAN 0#CAN 1#CAN 1#UART 0#UART 0#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3}  \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk#n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow###gpio1[26]#gpio1[27]#gpio1[28]#gpio1[29]#gpio1[30]#gpio1[31]#reset#gpio1[33]#scl_out#sda_out#gpio1[36]#gpio1[37]#phy_rx#phy_tx#phy_tx#phy_rx#rxd#txd#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out}  \
    ...
    CONFIG.PSU_MIO_30_PULLUPDOWN {pulldown}  \
    ...
    CONFIG.PSU__CRL_APB__PL1_REF_CTRL__DIVISOR0 {12}  \
    ...
    CONFIG.PSU__CRF_APB__ACPU_CTRL__ACT_FREQMHZ {525.000000}  \
    ...
    CONFIG.PSU__CRL_APB__PL1_REF_CTRL__ACT_FREQMHZ {125.000000}  \
    CONFIG.PSU__CRL_APB__PL2_REF_CTRL__ACT_FREQMHZ {40.000000}  \
    CONFIG.PSU__CRL_APB__PL3_REF_CTRL__ACT_FREQMHZ {40.000000}  \
...
set pl_clk1 [get_bd_pins $zynq_ultra_ps/pl_clk1]
make_bd_pins_external $pl_clk1
set_property name pl_clk_125 [get_bd_ports -of_objects [get_bd_nets -of_objects $pl_clk1]]
set pl_clk1_port [get_bd_ports -of_objects [get_bd_nets -of_objects $pl_clk1]]
